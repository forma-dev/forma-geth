...
const (
	...
	PrecompileCompress     PrecompileType = "compress"
	PrecompileJsonUtil     PrecompileType = "jsonutil"
	PrecompileJsonStore    PrecompileType = "jsonstore"
	PrecompileNativeMinter PrecompileType = "nativeminter"
	PrecompileStrings      PrecompileType = "strings"
	PrecompileIntegers     PrecompileType = "integers"
)
