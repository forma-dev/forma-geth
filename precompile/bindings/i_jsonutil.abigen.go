...
// GetRaw is a free data retrieval call binding the contract method 0x86212408.
//
// Solidity: function getRaw(string jsonBlob, string path) view returns(string)
func (_JsonUtil *JsonUtilCaller) GetRaw(opts *bind.CallOpts, jsonBlob string, path string) (string, error) {
	var out []interface{}
	err := _JsonUtil.contract.Call(opts, &out, "getRaw", jsonBlob, path)
...
//
// Solidity: function getRaw(string jsonBlob, string path) view returns(string)
func (_JsonUtil *JsonUtilSession) GetRaw(jsonBlob string, path string) (string, error) {
	return _JsonUtil.Contract.GetRaw(&_JsonUtil.CallOpts, jsonBlob, path)
}

// GetRaw is a free data retrieval call binding the contract method 0x86212408.
//
// Solidity: function getRaw(string jsonBlob, string path) view returns(string)
func (_JsonUtil *JsonUtilCallerSession) GetRaw(jsonBlob string, path string) (string, error) {
	return _JsonUtil.Contract.GetRaw(&_JsonUtil.CallOpts, jsonBlob, path)
}
